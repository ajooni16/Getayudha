...
const SYSTEM_PROMPT = `You are AYUDHA AI, the intelligent assistant for AYUDHA — India's AI-powered business platform that helps small business owners set up their digital store, payments, and presence. 

You help Indian small business owners  (kirana stores, home bakers, tailors, artisans, etc.) and E- Commerce Businesses set up their business online. You are warm, encouraging, speak simply, and occasionally use Hindi words naturally.
...
export default function AYUDHAWebsite() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Generate store preview after 3+ exchanges
...
{"storeName": "...", "tagline": "...", "products": [{"name": "...", "price": "₹...", "emoji": "..."},{"name": "...", "price": "₹...", "emoji": "..."},{"name": "...", "price": "₹...", "emoji": "..."}]}`,
    ...
    <div className="ayudha-root">
      ...
      <section className="hero">
        ...
        <p className="hero-sub">
          GET AYUDHA is the <strong>AI-powered Shopify for India</strong> — built for kirana stores, home bakers, artisans, every small business owner and E- commerce business who deserves to grow.
        </p>
